...
public class Build {
    ...
    public static final String LINEAGEOS_VERSION = getString("ro.mtkosp.version");

    /** A build ID string meant for displaying to the user */
    public static final String LINEAGEOS_DISPLAY_VERSION = getString("ro.mtkosp.display.version");
    ...
    public static class LINEAGE_VERSION {
        ...
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.mtkosp.build.version.plat.sdk", 0);
    }
